...
"lg",
"xl",
"At least listener of the StateNotifier ",
...
"AutoPlacement.rowSparse",
"AutoPlacement.rowDense",
"AutoPlacement.columnSparse",
"AutoPlacement.columnDense",
"toString() called on unknown AutoPlacement",
"Row (",
") has the wrong number of area names, ",
"expected=",
" found=",
"Invalid area name, name=",
"Must be in /^[a-zA-Z][\\w\\d-_]*$/",
"^\\.$",
"Area disjoint, column=",
" row=",
" name=",
"^[^\\.\\s]+$",
"\\s+",
"Missing cells from grid area template. ",
"Areas must be rectangular. name=",
"GridArea(",
"name=",
"columnSpan=[",
"–",
...
"GridPlacement.rowEnd cannot exceed row count\n",
"GridCell(",
", isOccupied=",
"┼",
"\n|",
